...
most promising first, ONE per line, each ending in a period. Prefer: psimpl, lia, step,
whammer, rewriting with a retrieved lemma, destruct/case analysis on a register or branch
condition. No prose, no numbering, no markdown — just tactics."""
